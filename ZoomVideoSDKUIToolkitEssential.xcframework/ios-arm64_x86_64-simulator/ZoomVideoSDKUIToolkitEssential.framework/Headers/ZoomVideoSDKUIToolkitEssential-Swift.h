...
#ifndef ZOOMVIDEOSDKUITOOLKITESSENTIAL_SWIFT_H
#define ZOOMVIDEOSDKUITOOLKITESSENTIAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZoomVideoSDKUIToolkitEssential",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential11AVPreviewVC")
...
@interface AVPreviewVC (SWIFT_EXTENSION(ZoomVideoSDKUIToolkitEssential)) <ZoomVideoSDKDelegate>
...
@interface AVPreviewVC (SWIFT_EXTENSION(ZoomVideoSDKUIToolkitEssential)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential24ActiveSpeakerGalleryView")
...
@interface ActiveSpeakerGalleryView (SWIFT_EXTENSION(ZoomVideoSDKUIToolkitEssential)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential9CTANavBar")
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential14InitParamsObjC")
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential18SessionContextObjC")
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential11TitleNavBar")
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential20UIToolkitErrorParser")
...
SWIFT_CLASS("_TtC30ZoomVideoSDKUIToolkitEssential11UIToolkitVC")
...
@interface UIToolkitVC (SWIFT_EXTENSION(ZoomVideoSDKUIToolkitEssential)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didEndDisplayingCell:(UICollectionViewCell * _Nonnull)cell forItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView willDisplayCell:(UICollectionViewCell * _Nonnull)cell forItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
@interface UIToolkitVC (SWIFT_EXTENSION(ZoomVideoSDKUIToolkitEssential)) <ZoomVideoSDKDelegate>
- (void)onError:(ZoomVideoSDKError)ErrorType detail:(NSInteger)details;
